...
public final class ExampleProvider extends Provider {
    ...
    public ExampleProvider(String name, CryptoBackend cryptoBackend) {
        ...
        putService(new MyService
            (this, "MessageDigest", "MD5", "com.vteba.security.ExampleProvider$MyMessageDigest"));
        putService(new MyService
            (this, "MessageDigest", "SHA1", "com.vteba.security.ExampleProvider$MyMessageDigest"));
        putService(new MyCipherService
            (this, "Cipher", "DES", "com.vteba.security.ExampleProvider$MyCipher"));
        putService(new MyCipherService
            (this, "Cipher", "AES", "com.vteba.security.ExampleProvider$MyCipher"));
    }
