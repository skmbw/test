...
public class Demo4HTMLFile2PDF {
    ...
    public static void main(String[] args) throws Exception {
        String htmlFile = "d:/template/w62.doc";
     ...
     * HTML文件转为PDF中的Elements,便于把HTML内容追加到已有的PDF中
     *
     * @param outputStream pdf文件写到哪里——输出流
     * @param htmlFileStream html源文件
     */
    public static void parseHTML2PDFElement(OutputStream outputStream, InputStream htmlFileStream) {
        try {
            Document document = new Document(PageSize.A4);
            PdfWriter.getInstance(document, outputStream);
            document.open();
