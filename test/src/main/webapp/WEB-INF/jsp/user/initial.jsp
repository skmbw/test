...
<td><a href="${ctx}/user/detail.htm?id=${user.id}">详情</a> <a href="${ctx}/user/edit?id=${user.id}">编辑</a> <a href="javascript:void(0);" onclick="javascript:deleteUser('${user.id}');">删除</a></td>
</tr>
